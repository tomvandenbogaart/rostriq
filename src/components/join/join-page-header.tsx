...
import { Company, CompanyInvitation } from '@/types/database';

interface JoinPageHeaderProps {
  company: Company;
  invitation: CompanyInvitation;
}

export function JoinPageHeader({ company, invitation }: JoinPageHeaderProps) {
  return (
