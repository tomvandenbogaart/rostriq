...
export class CompanyInvitationsService {
  ...
  private generateSecureToken(): string {
    console.log('generateSecureToken called');
   ...
   * Only accepts 64-character hex strings for security
   */
  isValidToken(token: string): boolean {
    // Validate 64-character hex string (generated by generateSecureToken)
